  ...
  ; <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="2500">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="welcomeSAT.jpg" alt="Chania" width="460" height="345">
      ...
      <div class="item">
        <img src="einstein.jpg" alt="Chania" width="460" height="345">
        <div class="carousel-caption">
          <h3>Input</h3>
		...
		<div class="item">
        <img src="sharingidea.jpg" alt="Chania" width="460" height="345">
        <div class="carousel-caption">
          <h3>View</h3>
