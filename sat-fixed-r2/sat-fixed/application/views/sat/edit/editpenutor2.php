...
.row.content {height:auto;} 
  ...
  <div class="panel panel-info">
    <div class="panel-heading" id="judul">Edit Penutor</div>
	...
	<?php
		$attribute = array( 'class' => 'form-horizontal',
		       'role' => 'form');
		echo form_open('editpenutor/tampil',$attribute);
	    ...
	    <form class="form-horizontal" role="form">
				...
				?>
				<div class="form-group">
				<label for="pwd">Penutor Mata Kuliah :</label>
                   <?php
							$puter = 0;
  ...
  <strong>Error!</strong> MK kosong !
	...
	echo '<div class="alert alert-danger">
  <strong>Error!</strong> Bukan Penutor !
</div>';
  ?>
			<script>
			function bersihkan(){
